-- -------------------------------------------------------------
--
-- Module: hdlcoder_pre_filter_tb_pkg
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-10-01 02:35:52
-- -------------------------------------------------------------
...
PACKAGE hdlcoder_pre_filter_tb_pkg IS

  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 4063) OF std_logic_vector(9 DOWNTO 0);
...
END hdlcoder_pre_filter_tb_pkg;

PACKAGE BODY hdlcoder_pre_filter_tb_pkg IS
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(4063, 12 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(4063, 12 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
-- -------------------------------------------------------------
--
-- Module: hdlcoder_pre_filter_tb_data
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-10-01 02:35:52
-- -------------------------------------------------------------
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.hdlcoder_pre_filter_tb_pkg.ALL;

PACKAGE hdlcoder_pre_filter_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_in_data_log_type;

END hdlcoder_pre_filter_tb_data;

PACKAGE BODY hdlcoder_pre_filter_tb_data IS
...
USE work.hdlcoder_pre_filter_tb_data.ALL;

ENTITY hdlcoder_pre_filter_tb IS

END hdlcoder_pre_filter_tb;


ARCHITECTURE rtl OF hdlcoder_pre_filter_tb IS
  -- -------------------------------------------------------------
  -- Component Declarations
  -- -------------------------------------------------------------
  COMPONENT hdlcoder_pre_filter
  ...
  -- -------------------------------------------------------------
  FOR ALL : hdlcoder_pre_filter
    USE ENTITY work.hdlcoder_pre_filter(rtl);
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 4064; -- uint32
  ...
  SIGNAL filter_out                       : std_logic_vector(9 DOWNTO 0); -- sfix10_En5
  ...
  SIGNAL filter_out_ref                   : std_logic_vector(9 DOWNTO 0); -- sfix10_En5
  SIGNAL check1_Done                      : std_logic; -- boolean


BEGIN
  -- Component Instances
  u_hdlcoder_pre_filter: hdlcoder_pre_filter
    PORT MAP (
              clk                              => clk,
