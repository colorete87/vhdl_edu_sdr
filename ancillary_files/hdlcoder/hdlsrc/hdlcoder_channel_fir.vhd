...
ARCHITECTURE rtl OF hdlcoder_channel_fir IS
  ...
  -- Constants
  CONSTANT coeff1                         : signed(15 DOWNTO 0) := to_signed(16384, 16); -- sfix16_En14
  CONSTANT coeff2                         : signed(15 DOWNTO 0) := to_signed(0, 16); -- sfix16_En14

  -- Signals
  SIGNAL delay_pipeline                   : delay_pipeline_type(0 TO 1); -- sfix10_En8
  SIGNAL product1_cast                    : signed(30 DOWNTO 0); -- sfix31_En29
...
BEGIN
  ...
  output_typeconvert <= resize(shift_right(product1_cast(30 DOWNTO 0) + ( "0" & (product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21) & NOT product1_cast(21))), 21), 10);
