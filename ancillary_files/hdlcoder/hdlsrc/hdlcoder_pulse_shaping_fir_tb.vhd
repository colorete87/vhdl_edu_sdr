...
-- Generated on: 2020-09-23 05:37:22
-- -------------------------------------------------------------
...
PACKAGE hdlcoder_pulse_shaping_fir_tb_pkg IS
  ...
  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 3960) OF std_logic_vector(1 DOWNTO 0);
  TYPE filter_out_type IS ARRAY (0 TO 3960) OF std_logic_vector(9 DOWNTO 0);
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(3960, 12 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(3960, 12 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
ARCHITECTURE rtl OF hdlcoder_pulse_shaping_fir_tb IS
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 3961; -- uint32
