-- -------------------------------------------------------------
--
-- Module: hdlcoder_pulse_shaping_fir_tb_pkg
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-10-01 02:35:24
-- -------------------------------------------------------------
...
PACKAGE hdlcoder_pulse_shaping_fir_tb_pkg IS

  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 3624) OF std_logic_vector(1 DOWNTO 0);
  TYPE filter_out_type IS ARRAY (0 TO 3624) OF std_logic_vector(9 DOWNTO 0);
...
END hdlcoder_pulse_shaping_fir_tb_pkg;

PACKAGE BODY hdlcoder_pulse_shaping_fir_tb_pkg IS
...
-- -------------------------------------------------------------
--
-- Module: hdlcoder_pulse_shaping_fir_tb_data
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-10-01 02:35:24
-- -------------------------------------------------------------
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.hdlcoder_pulse_shaping_fir_tb_pkg.ALL;

PACKAGE hdlcoder_pulse_shaping_fir_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_out_type;

END hdlcoder_pulse_shaping_fir_tb_data;

PACKAGE BODY hdlcoder_pulse_shaping_fir_tb_data IS
...
-- -------------------------------------------------------------
--
-- Module: hdlcoder_pulse_shaping_fir_tb
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-10-01 02:35:23
-- -------------------------------------------------------------
...
USE work.hdlcoder_pulse_shaping_fir_tb_data.ALL;

ENTITY hdlcoder_pulse_shaping_fir_tb IS

END hdlcoder_pulse_shaping_fir_tb;


ARCHITECTURE rtl OF hdlcoder_pulse_shaping_fir_tb IS
  -- -------------------------------------------------------------
  -- Component Declarations
  -- -------------------------------------------------------------
  COMPONENT hdlcoder_pulse_shaping_fir
  ...
  -- -------------------------------------------------------------
  FOR ALL : hdlcoder_pulse_shaping_fir
    USE ENTITY work.hdlcoder_pulse_shaping_fir(rtl);
  ...
  SIGNAL filter_in                        : std_logic_vector(1 DOWNTO 0); -- sfix2
...
BEGIN
  -- Component Instances
  u_hdlcoder_pulse_shaping_fir: hdlcoder_pulse_shaping_fir
    PORT MAP (
              clk                              => clk,
