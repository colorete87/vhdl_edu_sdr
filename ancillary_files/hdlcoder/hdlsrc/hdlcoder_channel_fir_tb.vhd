-- -------------------------------------------------------------
--
-- Module: hdlcoder_channel_fir_tb_pkg
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-09-25 02:47:19
-- -------------------------------------------------------------
...
PACKAGE hdlcoder_channel_fir_tb_pkg IS

  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 3085) OF std_logic_vector(9 DOWNTO 0);
...
END hdlcoder_channel_fir_tb_pkg;

PACKAGE BODY hdlcoder_channel_fir_tb_pkg IS
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(3085, 12 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(3085, 12 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
-- -------------------------------------------------------------
--
-- Module: hdlcoder_channel_fir_tb_data
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-09-25 02:47:19
-- -------------------------------------------------------------
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.hdlcoder_channel_fir_tb_pkg.ALL;

PACKAGE hdlcoder_channel_fir_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_in_data_log_type;

END hdlcoder_channel_fir_tb_data;

PACKAGE BODY hdlcoder_channel_fir_tb_data IS
...
-- -------------------------------------------------------------
--
-- Module: hdlcoder_channel_fir_tb
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2020-09-25 02:47:18
-- -------------------------------------------------------------
...
USE work.hdlcoder_channel_fir_tb_data.ALL;

ENTITY hdlcoder_channel_fir_tb IS

END hdlcoder_channel_fir_tb;


ARCHITECTURE rtl OF hdlcoder_channel_fir_tb IS
  -- -------------------------------------------------------------
  -- Component Declarations
  -- -------------------------------------------------------------
  COMPONENT hdlcoder_channel_fir
  ...
  -- -------------------------------------------------------------
  FOR ALL : hdlcoder_channel_fir
    USE ENTITY work.hdlcoder_channel_fir(rtl);
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 3086; -- uint32
...
BEGIN
  -- Component Instances
  u_hdlcoder_channel_fir: hdlcoder_channel_fir
    PORT MAP (
              clk                              => clk,
